...
#[derive(Debug)]
pub(crate) struct DispatchEventDeserializer(pub(crate) DispatchEventType);
...
impl DispatchEventType {
    /// Discord event name.
    ///
    /// Matches the [`Deserialize`] and [`Serialize`] implementations.
